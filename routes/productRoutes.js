...
router.put("/:id", verifyAdmin, productController.updateProduct); // Chỉ admin mới vào được
router.delete("/:id", verifyAdmin, productController.deleteProduct); // Chỉ admin mới vào được
router.put("/:id",verifyAdmin,productController.activateProduct); // Chỉ admin mới vào được
